...
both: atara/\cjk{あたら} and shin/\cjk{シン}; Eng.\ 'new'), which is one of the 
...
\begin{enumerate}
 ...
 \item \textbf{Ideograms} are combinations of two or more pictographical
       ...
       See table~\ref{table:Kanjiideograms}\ (after~\shortciteANP{Kano1990}~\citeyear{Kano1990}) for 
...
after~\shortciteANP{Foljanty1984}~\citeyear{Foljanty1984}.
\begin{figure}[htbp]
\begin{center}
...
based on semantic criteria. For example, in the character \cjk{杉}~(Jap.\ pron.\ 
...
\cjk{木} (tree) and not \cjk{彡} (hair). 
\shortciteANP{Hadamitzky1995}~\citeyear{Hadamitzky1995} files it under the 
\cjk{木} (tree) class radical. %Namely at entry 1872
