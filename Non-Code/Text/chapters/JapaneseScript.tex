...
\begin{enumerate}
 ...
 \item \textbf{Phonograms} are combinations of two Kanji characters. One of those
       refers to a concept class (class characters or \emph{radicals}), 
       ...
       of pronunciation 'ki' only, while the \emph{class radical} defines an
       ...
       Phonograms are yyy s. 34, 95% bla
