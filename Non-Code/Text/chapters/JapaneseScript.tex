...
Eng.~'national script'), a script based on the Latin alphabet. In South Korea the Han 
...
written in that script~\shortcite{Lange1922}.
...
Latin script, so called \cjk{ロマジ} (\emph{Romaji}, a Latin or 'Roman' 
