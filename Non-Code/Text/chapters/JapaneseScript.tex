...
the individual characters and their readings). The underlinded last part is 
...
culture is unbowed:\\
There are many books available centered around cultural interchange between
the western and Japanese culture. For example,~\shortcite{Haschke2008} present
German words of Japanese heritage, i.e. a miniature ethymological lexicon.
The sheer existance of that type of book on the free market suggests that 
  ...
  \item \textbf{Mnemonic methods} - Methods that use mnemonics in order to help
        ...
        \begin{enumerate}
          \item \textbf{Textual mnemonics} The \emph{Heisig method} assigns a 
                ...
                These mnemonics are little stories oriented towards the shape
          ...
          \item \textbf{Visual mnemonics} \emph{Kanji Pict-O-Graphix} is 
                ...
                depicted with images that represent the meanting of the Kanji.
...
\begin{enumerate}
  ...
  \item \textbf{Unusual readings.} Since Kanji have several readings, 
        ...
        while the Japanse reading (\emph{kun-reading}) is \cjk{ゆき}/yuki.
        ...
        while the Japanse reading (\emph{kun-reading}) is \cjk{くず}/kuzu.
  ...
  \item \textbf{Infrequnt Jōyō Kanji.} There are Kanji that are in the official
