...
\cjk{韓國語}; Eng.\ 'Korean')~\shortcite{Foljanty1984}.
...
19th.\ century~\shortcite{Foljanty1984}. The \emph{Kogo Shūi} 
(Jap.\ \cjk{古語拾遺}; a historical record of the Inbe clan),
...
that script has been found~\shortcite{Lange1922}.

In 712 A.D.\ an ancestral act of writing was performed at 
...
spoken Japanese~\shortcite{Chamberlain1982,Grassmuck1997}.
...
(Chinese \cjk{商朝}), which ruled over China for some 500 to 600 years within 
the time period between 1600 B.C.\ and 1046 
B.C.~\shortcite{Grassmuck1997,Guo2000}.

According to the Kojiki, a scholar called Wani (Jap.\ \cjk{王仁}) from Korea 
brought two foundational Chinese books to Japan: 
\begin{itemize}
  \item The \emph{Lunyu} 
        (Simplified Chin.\ \cjk{论语}; 
        trad.\ Chinese: \cjk{論語}; Eng.\ 'Analects'), 
        also known as \emph{The Analects of Confucius}.
  \item The \emph{Qianziwen} (Chin./Jap.\ \cjk{千字文}; Jap.\ 
        pron.\ \cjk{センジブン}/senjibun; 
...
\shortciteANP{Lange1922}~\citeyear{Lange1922} demurs strongly against this view 
...
use. They are still called Jōyō Kanji~\shortcite{Noguchi2009}. 
...
from~\shortciteANP{Katsuki2006Book}~\citeyear{Katsuki2006Book}:
\begin{exe}
...
in~\shortciteANP{Katsuki2006Book}~\citeyear{Katsuki2006Book}. Without prior
...
any more. %xxx citation missing here
In principle each character represents a syllable, which can contain either only 
a vowel (like 'u', \cjk{う}) or a consonant and a vowel (like 'ta', \cjk{た}). 
The nasal consonant \cjk{ん} ('n') is separate from that system as it is the
...
produce it in writing. Say, the Kanji in question was~\cjk{新}~(Jap.\ pron.\ 
both: atara/\cjk{あたら} and shin/\cjk{シン}; Eng.\ 'new'),
...
\begin{itemize}
  ...
  \item \textbf{Handakuten} (\cjk{半濁点},
        ...
        with a /p/ phoneme. The glyph for a 'maru' is a little circle (\cjk{゜})
...
Correspondingly, since the Handakuten only yields a /p/ sound, 
...
like \cjk{マリア} (\emph{maria}) and \cjk{アニメ} (\emph{anime}) from 
...
\cjk{口}~\shortcite{Hadamitzky1995}. Other examples of that reduction process
...
\end{table}
\newpage
\noindent The Kanji can be classified according to their building principle:
\begin{enumerate}
 \item \textbf{Pictograms} are graphically simplified images of real artefacts.
       ...
       from~\shortciteANP{Kano1990}~\citeyear{Kano1990}).
 ...
 \item \textbf{Ideograms} are combinations of two or more pictographical
       ...
       from~\shortciteANP{Kano1990}~\citeyear{Kano1990}) and shows  
...
denotes more than one morpheme~\shortcite{Foljanty1984}.
...
as shown in~\shortciteANP{Foljanty1984}~\citeyear{Foljanty1984}.
\begin{figure}[htbp]
\begin{center}
...
based on semantic criteria. For example, in the ideogram \cjk{杉}~(Jap.\ pron.\ 
...
logically be~\cjk{木} (tree) and not~\cjk{彡} (hair).
This hypothesis is supported by
\shortciteANP{Hadamitzky1995}~\citeyear{Hadamitzky1995}, 
who files it under the \cjk{木} (tree) class radical. %Namely at entry 1872
...
\cjk{山}~is read Sino-Japanese \emph{san} (alternatively in a phonetic 
...
\end{itemize}
\cjk{山} is read in the Japanese Kun-reading in the following words:
\begin{itemize}
...
\end{xlist}
\end{exe}
For instance, compare examples~\ref{exe:stemspellingkaeru}
and~\ref{exe:stemspellingkawaru}. 
The Japanese verb ending is 
\cjk{る}~(Hiragana: \emph{ru}). Part of the verb stem is expressed with
Hiragana too. In example~\ref{exe:stemspellingkaeru} it is the 
\cjk{え}~(Hiragana: \emph{e}) while in example~\ref{exe:stemspellingkawaru} 
it is the \cjk{わ}~(Hiragana: \emph{wa}).
...
The following quote from~\shortciteANP{Lange1922}~\citeyear{Lange1922} shows the 
...
\shortcite{Lange1922}, translation by the author of this thesis.
\end{quote}
...
of characters. \shortciteANP{Foljanty1984}~\citeyear{Foljanty1984} reports that 
...
have several readings~\shortcite{Hadamitzky1995,Yuan2005}. 
...
\shortciteANP{Haschke2008}~\citeyear{Haschke2008} present
...
\begin{enumerate}
  ...
  \item \textbf{Unusual readings.} Since Kanji have several readings, 
        ...
        *'snow landslide'). The reading however, is quite unexpected. Instead of
        ...
        exhausting experience for a learner. % Kanji 949 and 1122
        ...
        conjugations in English~\shortcite{Wydell1998}.
  ...
  \item \textbf{Homophones.} Japanese has several homophones. An extreme example
        is \cjk{きょう}~(\emph{kyou}): Around 80 Kanji have at least one 
...
sample~\shortcite{Hadamitzky1995}. This difficulty can only be overcome with 
