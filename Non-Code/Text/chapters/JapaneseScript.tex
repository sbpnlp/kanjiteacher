...
For example the character \cjk{加}, which was used to represent the pronunciaton
...
%\label{sec:readings}
%Foljanty 2.1.7
%xxx do we need to say anything at all about readings?
%why? does it actually have something to do with the characters?
%maybe to illustrate difficulties
...
is written and spelled the way it is.
\begin{exe}
...
Difficulties in machine writing Japanese also occured at later stages. The 
...
machines needed to print Japanse characters was small, because even business
...
http://appleotaku.com/four-ways-to-learn-kanji/

Interest and fascination is unbroken: see books like Haschke Thomas.


\subsection{From online forum}
Wenn man mal bei 1000 Kanji ist geht die Geschwindigkeit extrem zurück.

\begin{itemize}
\item Problem 1: Ähnliche Kanji. Um Zeichen wie \cjk{営} in \cjk{営業} und \cjk{管} in \cjk{管理} auseinanderhalten zu können muss man schon sehr konzentriert lernen. Speziell wenn man aus der Uni raus ist und Japanisch vor allem am PC tippt und nicht mehr mit der Hand schreibt.
\item Problem 2: Komposita. Man lernt zwar nicht unbedingt neue Kanji, sondern neue Vokabeln, die aus bereits bekannten Zeichen zusammengesetzt sind. Wenn man davon 1000 pro Monat pauken will ist wenig Platz für Kanji.
\item Problem 3: ungewöhnliche Lesungen. Wer merkt sich schon Lesungen wie \cjk{なだれ} für \cjk{雪崩}? Wäre mir das nicht neulich erst wieder in Onepiece über den Weg gelaufen, hätte ich das sicher längst wieder vergessen.
\item Problem 4: Alternativkanji. Warum sich \cjk{壱} merken wenn es 一 auch tut?
\item Problem 5: Homophone. Das erste \cjk{きょう} geht noch, auch das zweite, dritte... nur wenn man 80 Zeichen kennen soll, die alle \cjk{きょう} gelesen werden, weiss man dann noch, welche das sind?
\item Problem 6: Kanji, die zwar als Joyo geführt werden, aber kaum verwendet werden. \cjk{犠} und \cjk{牲} aus \cjk{犠牲} zum Beispiel. Kommt nur in einem häufiger verwendeten Wort vor und auch das ist nicht so geläufig.
\item Problem 7: Nicht-Joyo-Kanji. Nur weil ein Kanji nicht in der Joyo-Liste ist, heisst das noch lange nicht, dass man es nicht zumindest passiv beherrschen muss. Allein der harmlose Satz \cjk{誰かが茨城の出身ですか} enthält zwei (von fünf).
\end{itemize}
