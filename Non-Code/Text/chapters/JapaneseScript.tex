...
scripts serve as auxiliary scripts. The \cjk{送り仮名}~(Jap. pron. 
\cjk{ オクリガナ}/okurigana; Eng. 'accompanying characters') are Kana that form 
...
%xxx: graphic here, one or two characters and their reduction from kanji to 
%hiragana S. 42, foljanty

The other method of reduction was using a Grapheme to represent the whole 
character.

%xxx: graphic here, one or two characters and their reduction from kanji to 
%katakana S. 42, foljanty
