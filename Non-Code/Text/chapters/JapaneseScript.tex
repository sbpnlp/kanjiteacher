...
language'), a script based on the Latin alphabet. In South Korea the Han characters were in use until their replacement with Hangul \shortcite{Foljanty1984}.
...
Hangugeo~(Kor. with Han characters \cjk{韓國語}; Eng. Korean)
yyy

%refer to the oracle bone: http://en.wikipedia.org/wiki/Oracle_bone
