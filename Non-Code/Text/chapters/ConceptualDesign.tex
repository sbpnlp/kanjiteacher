  ...
  \item \textbf{Script teachers}. Script teaching applications are designed 
        ...
        \begin{itemize}
          \item \textbf{Multiple choice}. The large majority of e-learning 
                ...
                asked for.
          \item \textbf{Handwriting input}. There are only two 
                applications
...
\paragraph{Kanjigym Light} does not measure anything. The application provides
a canvas for writing charaters. The user can input a character and then
click a button named \emph{check}. The correct character appears next to the
user input and leaves it to the user to compare for correctness.
There is an accept and a discard button.
\begin{itemize}
