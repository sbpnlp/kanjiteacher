...
\begin{itemize}
 ...
 The user's errror is not analysed and the user does not get a feedback
...
it can be aussumed that the users can learn from incorrect input.
...
which is usually written as~\cjk{一} but~\cjk{壱} can be used as an alternateve.
