...
\shortciteANP{Richert2007}~\citeyear{Richert2007} criticises 
\shortciteANP{Rosenberg2006}'s~\citeyear{Rosenberg2006} definition because she 
...
\shortciteANP{Richert2007}~\citeyear{Richert2007} defines e-learning as:
  \begin{quote}
...
\shortciteANP{Richert2007}~\citeyear{Richert2007}
uses the term is broader sense 
than~\shortciteANP{Rosenberg2006}~\citeyear{Rosenberg2006},
...
as depicted by~\shortciteANP{Richert2007}~\citeyear{Richert2007}.
\begin{table}[htbp]
\begin{center}
...
borrowed from~\shortciteANP{Richert2007}~\citeyear{Richert2007}
...
cause~\shortcite{Lefrancois1994}. According 
to~\shortciteANP{Richert2007}~\citeyear{Richert2007},
...
The general scheme of such a system is depicted after~\shortciteANP{Richert2007}~\citeyear{Richert2007} in 
...
In \emph{computer assisted language learning} (CALL) most of the systems are not
necessarily bound to the key competences for language learning. 
\shortciteANP{Richert2007}~\citeyear{Richert2007} defines the following key
...
ideal~\shortcite{Richert2007}.
\shortciteANP{Bailey2009}~\citeyear{Bailey2009} report about an intelligent 
...
process~\shortcite{Ismail2002}. Due to the impersonal nature of
...
a classical CALL application. It uses syntactical parsing in order
...
of language learning defined 
by~\shortciteANP{Richert2007}~\citeyear{Richert2007}. The definition of
...
E-learning systems for Japanese Kanji are described in 
section~\ref{sec:concept:classificationofkanjicoach}.

\subsubsection{Key Competences for Studying Japanese Script}
\label{sec:elearn:keycompetencesforstudyingjapanesescript}

The key competences defined by~\shortciteANP{Richert2007}~\citeyear{Richert2007}
(see section~\ref{sec:elearn:elearningoflanguages})
are orthogonal to those types of e-learning system focusing on the script. 
...
Despite the availability of modern technologies like video conference software
and on-line telephony, the most popular form of both immediate and delayed 
...
\section{E-Learning Summary}
\label{sec:elearn:summary}

In this chapter, the technical and educational context of e-learning have been
presented. Different system types and their classifications were shown and 
compared to each other. Intelligent tutorial systems were reviewed as well as
computer-assisted language learning methods.
This short review on e-learning together with the structure of the Japanese
writing system (chapter~\ref{chap:japanasescript}) serve as a basis for the 
conceptual design of the application developed in this thesis. 
The conceptual design is discussed in the following chapter.