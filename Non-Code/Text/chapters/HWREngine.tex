...
Therefore, the point coordinates are stored in the 
frameworks \emph{Point} class that does not account for time stamps.
Therefore a separate list is used for the timestamps only.
...
prototype is a structural error analysis. The desire for a structural error 
