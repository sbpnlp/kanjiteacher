...
minimal sum of squares of residuals. %xxx citation?
...
a feature vector is used. 

Different curve matching techniques are described in 
section~\ref{sec:curvematching}. The technique used here refers to 
\emph{curved strokes}, however, it is a vector-based technique, that aims at 
point reduction. 

\subsubsection{Identifying Curves in Strokes}
\label{sec:hwre:identifyingcurvesinstrokes}
