...
Java has the ability to set the look-and-feel to different systems, also to
windows. The Java virtual machine has long been known to run on different 
platforms, most importantly Linux and Windows, while the .NET framework has been
implemented for X-Systems by Novell and is called \emph{Mono}.
The 

und cross-device communication mit WCF vor whatever java does
C# vor Java
