...
by~\shortciteANP{Krasner1988}~\citeyear{Krasner1988}.
Figure~\ref{fig:modelviewcontroller} 
shows~\shortciteANP{Krasner1988}'s~\citeyear{Krasner1988} 
...
the model and the view~\shortcite{Krasner1988}.
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.5]{images/TechnicalDesign/MVC2.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.6]{images/TechnicalDesign/systemArchitecture.png}
...
The communication can be described as \emph{loose coupling} because different 
...
The main view of the system is a graphical user interface. It contains 
