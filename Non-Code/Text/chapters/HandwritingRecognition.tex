...
\shortcite{Nakagawa2008}. The approach of \shortcite{Jaeger2001a} utilises 
the Unipen format \shortcite{Guyon1994}, \shortcite{Unipen} in order to create Japanese 
character databases.
...
xxx: write a short note on hmm analysis.
for example cite \shortcite{Hu2000} and \shortcite{Hu1996} and maybe also
\shortcite{BahlmannBurkhardt2004}
:xxx
