...
characters (\cjk{汉字}) as they were imported into the Japanese language (see~\ref{sec:ahorthistoryofjapanesewritingsystem}).

They can even be blended within one word. Take for instance the verb 
\emph{taberu} (\cjk{食べる} - \emph{to eat}). The first character is a kanji 
...
phonetic reasons. However, without them, the character \cjk{食} still bears
