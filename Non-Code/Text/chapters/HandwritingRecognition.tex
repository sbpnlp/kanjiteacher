...
roughly the same techniques that \citeauthoryear{Tappert1990} depict.
\citeauthoryear{Santosh2009} also present the additional processing step of 
\emph{repetition removal}, which can be mapped to \emph{dot reduction}.
In the remainder of this section the typical preprocessing steps are presented 
in more detail.
