...
%An abugida, also called an alphasyllabary, is a segmental writing system, which
% is based on consonants, and in which vowel notation is obligatory but secondary.
Devanāgarī is a script used to write the Sanskrit, Prākrit, Hindi, Marathi, and Nepali languages, developed from the North Indian monumental script known as Gupta and ultimately from the Brāhmī alphabet, from which all modern Indian writing systems are derived \shortcite{EncyclopediaBritannicaDevanagari}.
} 
