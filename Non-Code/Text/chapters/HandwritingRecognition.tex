...
There might be exceptions, as \emph{0} (number between '-1' and '1') and 
...
in handwriting. It is possible to write a short vertical stroke for either
...
in a temporal sequence. Opposed to the latin-based alphabets, consider Chinese and
...
number or order. Figure~\ref{fig:differenthandwritingstyles}
...
\shortciteANP{Tappert1990}~\citeyear{Tappert1990} describe in their review the development of 
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.1]{images/Apple_Newton_MP100.png}
...
the user's writing speed. \shortciteANP{Tappert1990}~\citeyear{Tappert1990} report 
...
off-line systems have used algorithms of line-thinning, in order to
...
whole words~\shortcite{Tappert1990}. In Chinese and Japanese character recognition, 
...
(see section~\ref{sec:olccr:patterndescription} is another key task, however 
the actual classification is the main piece of software.
...
into smaller groups, so-called \emph{character classes}. These groups can be 
...
have rather curvy characters like Tamil~\shortcite{Joshi2004b,Niels2005} or 
...
\shortciteANP{Nakai2003}~\citeyear{Nakai2003} propose the automated generation of a dictionary for 
stroke-order free OLCCR. That approach is also based on substroke HMMs.
\shortciteANP{Shimodaira2003}~\citeyear{Shimodaira2003} propose a handwriting recognition interface for 
...
The system of~\shortciteANP{Okumura2005}~\citeyear{Okumura2005} uses not only the pen-direction feature 
