...
Handwriting recognition has been around for many years. It is the key technology
to pen-based computer systems. The first research papers concerned with 
...
the nature of the Chinese characters (see \ref{sec:generalmethods}).
