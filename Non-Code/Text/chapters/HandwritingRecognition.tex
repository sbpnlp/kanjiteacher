...
On-line handwriting recognition is a pattern-recognition problem that is centred
...
whether handwriting was going to survive. 
...
which script the character belongs to. 
...
the early 1960s. In a U.S.\ Patent~\shortciteANP{Goldberg1915}~\citeyear{Goldberg1915} describes 
...
from~\shortciteANP{Goldberg1915}'s~\citeyear{Goldberg1915} patent
...
\shortciteANP{Tappert1990}~\citeyear{Tappert1990} describe in their review 
...
Different styles of handwriting after~\shortciteANP{Tappert1990}~\citeyear{Tappert1990} can be seen in 
figure~\ref{fig:differenthandwritingstyles}.
...
the user's writing speed. \shortciteANP{Tappert1990}~\citeyear{Tappert1990} 
...
similar to the input of on-line systems~\shortcite{Tappert1990}. 
...
by~\shortciteANP{Nishida1995}~\citeyear{Nishida1995}, 
where an on-line and and off-line system are 
fully integrated with each other as a \emph{blend system}.
\shortciteANP{Velek2002a}~\citeyear{Velek2002a} determine the likelihood of 
...
\shortciteANP{Nakagawa2008}~\citeyear{Nakagawa2008} report their recent results of on-line Japanese 
...
pipeline architecture. The main parts of such an application are the following:
\begin{itemize}
...
\shortciteANP{Joshi2005}~\citeyear{Joshi2005} re-sample the strokes in a way that they yield a constant 
...
\shortciteANP{Tappert1990}~\citeyear{Tappert1990} distinguish between the phases \emph{external} and 
...
\emph{deskewing}, \emph{baseline drift correction} and \emph{size normalisation}.
\shortciteANP{Santosh2009}~\citeyear{Santosh2009} summarise a similar perception in their review about several
...
roughly the same techniques that~\shortciteANP{Tappert1990}~\citeyear{Tappert1990} depict.
\shortciteANP{Santosh2009}~\citeyear{Santosh2009} also present the additional processing step of 
...
characters~\shortcite{Tappert1990}.
...
\shortciteANP{Shimodaira2003}~\citeyear{Shimodaira2003} employ substroke HMMs in a wearable computing 
...
data~\shortcite{Santosh2009}. Some of the filter types are described in the 
...
is received~\shortcite{Tappert1990}. 
\shortciteANP{Joshi2005}~\citeyear{Joshi2005} employ a 5-tap low 
...
beginning of a stroke~\shortcite{Tappert1990}. Figure~\ref{fig:dehooking} shows
...
tablet to falsely report wild points~\shortcite{Tappert1990}.
...
average distance of the points of one stroke.
 ...
 \begin{figure}[tbhp]
   \begin{center}
 \includegraphics[scale=1.2]{images/Foriginal.png}
 \includegraphics[scale=1.2]{images/F1hooks.png}
 \includegraphics[scale=1.2]{images/F2afterDehooking.png}
 \caption{Dehooking}
 \label{fig:dehooking}
   \end{center}
 \end{figure}
 \begin{figure}[tbhp]
   \begin{center}
 \includegraphics[scale=1.2]{images/F3afterDehookingBeforeWildPointCorrection.png}
 \includegraphics[scale=1.2]{images/F4afterDehookingAndAfterWildPointCorrection.png}
...
points~\shortcite{Tappert1990}. Points that are accumulated on a very close 
...
character~\shortcite{Tappert1990}.
...
whole words~\shortcite{Tappert1990}. In Chinese and Japanese character 
recognition, slant correction can be applied in a similar fashion like with 
...
classification~\shortcite{Tappert1990}. 
...
dot~\shortcite{Tappert1990}. Some systems use a decision tree for 
...
\shortciteANP{Jaeger2001}~\citeyear{Jaeger2001} use 
...
in which each character is represented~\shortcite{Tappert1990}.
...
pen-up). \shortciteANP{Nakai2001}~\citeyear{Nakai2001} and 
\shortciteANP{Tokuno2002}~\citeyear{Tokuno2002} use the stroke 
direction feature combined with a pen-coordinate feature. 
\shortciteANP{Okumura2005}~\citeyear{Okumura2005} and others follow 
...
strokes~\shortcite{Nakagawa2008}. The approach 
...
\shortciteANP{Joshi2004a}~\citeyear{Joshi2004a} compare different elastic matching methods for Tamil 
...
of systems e.g., by~\shortciteANP{Vuori2001}~\citeyear{Vuori2001} (for Latin script), 
by~\shortciteANP{Niels2004}~\citeyear{Niels2004} (for Tamil), 
by~\shortciteANP{Joshi2004b}~\citeyear{Joshi2004b} (for Tamil) and 
by~\shortciteANP{Joshi2005}~\citeyear{Joshi2005} (for Devanagari). 
While the aforementioned systems use it for a single script, 
\shortciteANP{Bharath2009}~\citeyear{Bharath2009} attempt to create a HWR for several 
Indic scripts using the same technology. 
\shortciteANP{BahlmannBurkhardt2004}~\citeyear{BahlmannBurkhardt2004} use elastic 
...
with diverse kinds of pruning~\shortcite{Keogh2001,Chu2002,Bashir2008}.
...
\shortciteANP{Hu1996}~\citeyear{Hu1996},
\shortciteANP{Hu2000}~\citeyear{Hu2000} and also 
...
\shortciteANP{Shimodaira2003}~\citeyear{Shimodaira2003} proposed a method for overlaid handwriting 
...
display, allowing continuous writing for the user~\shortcite{Shimodaira2003}.
...
The system developed by~\shortciteANP{Nakagawa2008}~\citeyearNP{Nakagawa2008}
...
by~\shortciteANP{Tappert1990}~\citeyear{Tappert1990}
and by~\shortciteANP{Santosh2009}~\citeyear{Santosh2009}. 
...
representation~\shortcite{LiuJaegerNakagawa2004}. Systems that use statistical character
...
Several different approaches to structural character representation have been
...
sequences in the character database~\shortcite{LiuJaegerNakagawa2004}.
...
sub components. \shortciteANP{Nakagawa2008}~\citeyear{Nakagawa2008} employ basic 
...
\shortciteANP{ChenLee1996}~\citeyear{ChenLee1996} propose a hierarchical 
...
labour-intensive task. \shortciteANP{Breen2004}~\citeyear{Breen2004} proposed 
...
\emph{substroke approach}. \shortciteANP{Nakai2001}~\citeyear{Nakai2001}, 
\shortciteANP{Shimodaira2003}~\citeyear{Shimodaira2003},
\shortciteANP{Okumura2005}~\citeyear{Okumura2005} and others define 8 or more\footnote{Some systems 
...
Attempting to avoid stroke-order dependence of the system. Multiple HMMs
...
the actual classification is the main part of the recognition.
...
Efficient classification algorithms have shown to be necessary due to the 
...
database design phase~\shortcite{LiuJaegerNakagawa2004}.
...
\shortciteANP{LiuNakagawa2000}~\citeyear{LiuNakagawa2000} have shown that the 
...
Stroke number of the input pattern can also be used as a pre-selection of
...
that have rather curvy characters like Tamil~\shortcite{Joshi2004b,Niels2005} or 
Devanāgarī~\shortcite{Joshi2005}, but has also been applied to HWR of
latin-based alphabets~\shortcite{Vuori2001,Negussie2008}.
\shortciteANP{Niels2004}~\citeyear{Niels2004} and~\shortciteANP{Joshi2004a}~\citeyear{Joshi2004a} have done research into which 
...
than the other two methods~\shortcite{LiuJaegerNakagawa2004}.
...
\paragraph{HMM-based Classification} has been used frequently in recent years of
...
as opposed to one for each character. 

The substroke approach became popular
and has been used by~\shortciteANP{Nakai2001}~\citeyear{Nakai2001}. 
In a follow-up article, \shortciteANP{Nakai2003}~\citeyear{Nakai2003} propose 
the automated generation of a dictionary for 
stroke-order free OLCCR. That approach is also based on substroke HMMs.
\shortciteANP{Shimodaira2003}~\citeyear{Shimodaira2003} propose a 
...
The system of~\shortciteANP{Okumura2005}~\citeyear{Okumura2005} uses not only 
...
recognition~\shortcite{LiuJaegerNakagawa2004}.
