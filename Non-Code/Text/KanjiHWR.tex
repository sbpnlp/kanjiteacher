...
\input chapters/HandwritingRecognition.tex       %CHECK1 CHECK2 CHECK3 CHECK4
\input chapters/E-Learning.tex                   %CHECK1 CHECK2 CHECK3a CHECK3b CHECK4
 \input chapters/ConceptualDesign.tex             %CHECK1 CHECK2 CHECK3 CHECK4
\input chapters/TechnicalDesign.tex              %CHECK1 CHECK2 CHECK3 CHECK4
\input chapters/HWREngine.tex                    %CHECK1 CHECK2 CHECK3 CHECK4
\input chapters/ImplementationEvaluation.tex     %CHECK1 CHECK2ab CHECK3ab CHECK4
\input chapters/Conclusions.tex                  %CHECK1 CHECK2 CHECK3 CHECK4
\input chapters/Outlook.tex                      %CHECK1 CHECK2 CHECK3 CHECK4
\appendix
\input chapters/AppJapaneseScript.tex            %CHECK1 CHECK2 CHECK3 CHECK4
